...
if [ ! -f "$ROOT/xmlcalabash-app-3.0.0-alpha20.jar" ]; then
    echo "XML Calabash script did not find the 3.0.0-alpha20 distribution jar"
    exit 1
fi
...
CP="$ROOT/xmlcalabash-app-3.0.0-alpha20.jar"
